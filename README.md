...
<img src="./model_generated_images/3/sd_4000_121_58.png" width="768" height="768" alt="Figure 1.1: max_train_steps = 4000, learning_rate = 1e-05, #images of <trigger_word> = 121 & #images of <person> = 58">
